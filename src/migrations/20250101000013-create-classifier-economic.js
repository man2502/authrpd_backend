...
/**
 * Миграция для создания таблицы классификатора экономических расходов
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('classifier_economic', {
      code: {
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('classifier_economic');
  },
};
