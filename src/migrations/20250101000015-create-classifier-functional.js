...
/**
 * Миграция для создания таблицы классификатора функциональных расходов
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('classifier_functional', {
      code: {
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('classifier_functional');
  },
};
